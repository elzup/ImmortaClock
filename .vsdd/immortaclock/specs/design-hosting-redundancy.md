...
| Codeberg Pages | repo ミラー + Pages | 非営利(独) | 無料・無制限 | 稼働 | elzup.codeberg.page/ImmortaClock |
...
- REQ-HOST-4: repo ミラーは**無料・無制限**の条件を満たす先のみ採用すること(GitLab / Codeberg)。稼働中の Pages/静的配信は GitHub Pages + Cloudflare Workers + GitLab Pages + Codeberg Pages(いずれも稼働・別運営)とする。
